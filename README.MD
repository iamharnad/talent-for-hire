...
| Krishna Haranath | Front-End Developer/Software Engineer | Bangalore/Bengaluru, India | React.JS, TypeScript, Javascript, Context API/Redux, HTML5, CSS3, SASS, Bootstrap, REST API, Database Management, Git | Remote/Relocation | [Email](mailto:haranathpvsrk@gmail.com) <br /> [GitHub](https://github.com/iamharnad) <br /> [LinkedIn](https://www.linkedin.com/in/iamharnad/)|
